...
const ALL_CRAB_FRAMES = [
  ...Array.from({ length: 5 }, (_, i) => `${BASE}ani/crab-idle/Crab${i + 1}.png`),
  ...Array.from({ length: 4 }, (_, i) => `${BASE}ani/crab-jump/CrabMoving${i + 1}.png`),
  ...Array.from({ length: 4 }, (_, i) => `${BASE}ani/crab-attack/Crab_Attack${i + 1}.png`),
]
      ...
      <div className="relative flex items-center justify-center min-h-screen px-4">
        <div className="text-center max-w-2xl">
          ...
          >
            ...
            <span className="text-crab-600">&gt;</span> Integrated with LobsterBoard dashboard
          </motion.div>
